...
(function(h) {
        ...
        for (i = c.length; f < i; f++) {
            ...
            for (e = d.firstChild; e;) {
                if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
                    ...
                    u = 1 === l ? !0 : !1;
                    for (j = 0; j < l; j++)
                        for (g = 0; g < q; g++)(a[f + g][o + j] = { cell: e, unique: u }), (a[f + g].nTr = d);
                }
                e = e.nextSibling;
            }
        }
    ...
    function ub(a) {
        ...
        for (g = 0; g < c; g++)
            ...
            S.columns.push({ data: i, name: o.sName, searchable: o.bSearchable, orderable: o.bSortable, search: { value: l.sSearch, regex: l.bRegex } }),
            k("mDataProp_" + g, i),
    ...
    function ob(a) {
        for (
            var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = h.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = h("<select/>", { name: c + "_length", "aria-controls": c, class: b.sLengthSelect }), g = 0, j = f.length; g < j; g++
        )
    ...
    function Ha(a) {
        ...
        if (d || (!u && !f && !e && j == ca(a) && j == o.length))
            ...
            for (m = 0; m < i.length; m++)
                ...
                n.sWidthOrig && f && h(o[m]).append(h("<div/>").css({ width: n.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
            if (a.aoData.length)
    ...
    function W(a) {
        ...
        for (a = 0; a < o.length; a++) {
            ...
            for (c = f.length; b < c; b++)
                (g = f[b]), (j = e[g].sType || "string"), o[a]._idx === k && (o[a]._idx = h.inArray(o[a][1], e[g].asSorting)), d.push({ src: i, col: g, dir: o[a][1], index: o[a]._idx, type: j, formatter: m.ext.type.order[j + "-pre"] });
        }
        return d;
    }
    ...
    m = function(a) {
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                ...
                i = n.oClasses;
                e.bJQueryUI ?
                    (h.extend(i, m.ext.oJUIClasses, e.oClasses), e.sDom === l.sDom && "lfrtip" === l.sDom && (n.sDom = '<"H"lfr>t<"F"ip>'), n.renderer) ?
                    h.isPlainObject(n.renderer) && !n.renderer.header && (n.renderer.header = "jqueryui") :
                    (n.renderer = "jqueryui") :
    ...
    h.extend(s, { afnFiltering: s.search, aTypes: s.type.detect, ofnSearch: s.type.search, oSort: s.type.order, afnSortData: s.order, aoFeatures: s.feature, oApi: s.internal, oStdClasses: s.classes, oPagination: s.pager });
